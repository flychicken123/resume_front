...
const PricingPage = () => {
  ...
  const fetchCurrentSubscription = async () => {
    try {
      ...
      if (data.subscription && data.subscription.plan_name) {
        console.log('Setting current plan to:', data.subscription.plan_name);
  ...
  const handleSelectPlan = async (planName) => {
    ...
    if (planName === 'free' && (currentPlan === 'premium' || currentPlan === 'ultimate')) {
      ...
      <div className="pricing-container">
        ...
        <div className="pricing-cards">
          {PLAN_KEYS.map((planKey) => {
            ...
            console.log(`Plan: ${planKey}, CurrentPlan: ${currentPlan}, IsCurrentPlan: ${isCurrentPlan}, IsDowngrade: ${isDowngrade}`);
