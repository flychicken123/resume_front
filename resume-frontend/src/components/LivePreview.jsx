    ...
    switch (format) {
      ...
      case TEMPLATE_SLUGS.HARVARD_ATS:
        return {
          ...
          header: { textAlign: 'center', fontWeight: 700, fontSize: `${10.8 * scaleFactor}px`, marginBottom: `${2 * scaleFactor}px`, color: '#111827' },
          contact: { textAlign: 'center', color: '#111827', fontSize: `${5.5 * scaleFactor}px`, marginBottom: `${5 * scaleFactor}px` },
          sectionTitle: { color: '#111827', fontWeight: 700, fontSize: `${7.4 * scaleFactor}px`, marginBottom: `${2 * scaleFactor}px`, borderBottom: '1px solid #111827', paddingBottom: `${1 * scaleFactor}px`, textAlign: 'left', letterSpacing: '0.4px' },
          company: { color: '#111827', fontWeight: 700, fontSize: `${5.9 * scaleFactor}px` },
          bullet: { color: '#111827', fontSize: `${5.7 * scaleFactor}px`, marginLeft: `${4 * scaleFactor}px`, marginBottom: `${1.5 * scaleFactor}px` },
          summary: { color: '#111827', fontSize: `${5.7 * scaleFactor}px`, marginBottom: `${3 * scaleFactor}px` },
          skills: { color: '#111827', fontSize: `${5.6 * scaleFactor}px` },
          item: { marginTop: `${2.5 * scaleFactor}px` }
        };
      case TEMPLATE_SLUGS.TECH_MINIMAL:
        return {
          container: { fontFamily: 'Inter, Segoe UI, Arial, sans-serif', fontSize: `${6 * scaleFactor}px`, lineHeight: '1.2', padding: '16px 16px 0 18px', background: 'white', border: '1px solid #d1fae5', borderLeft: '6px solid #10b981', borderRadius: '4px', overflow: 'visible' },
          header: { textAlign: 'left', fontWeight: 800, fontSize: `${10 * scaleFactor}px`, marginBottom: `${3 * scaleFactor}px`, color: '#064e3b' },
          contact: { textAlign: 'left', color: '#475569', fontSize: `${6 * scaleFactor}px`, marginBottom: `${6 * scaleFactor}px`, borderBottom: '1px solid #a7f3d0', paddingBottom: `${4 * scaleFactor}px` },
          sectionTitle: { color: '#047857', fontWeight: 700, fontSize: `${8.2 * scaleFactor}px`, marginBottom: `${2.5 * scaleFactor}px`, textTransform: 'uppercase', letterSpacing: '1px', borderBottom: '1px solid #d1fae5', paddingBottom: `${1.5 * scaleFactor}px`, textAlign: 'left' },
          company: { color: '#0f172a', fontWeight: 700, fontSize: `${6 * scaleFactor}px` },
          bullet: { color: '#334155', fontSize: `${6 * scaleFactor}px`, marginLeft: `${3.5 * scaleFactor}px`, marginBottom: `${1.5 * scaleFactor}px` },
          summary: { color: '#334155', fontSize: `${6 * scaleFactor}px`, marginBottom: `${3 * scaleFactor}px` },
