    ...
    return (
      <div className="job-application-page">
        <SEO
          ...
          description="Preview the job application package generated by HiHired before you submit. Confirm job details, resume content, and follow customized next steps."
  ...
  return (
    <div className="job-application-page">
      <SEO
        ...
        description={`Review the customized resume and application details for ${jobInfo.job_title || 'this role'} at ${jobInfo.company_name || 'the selected company'}.`}
      ...
      <div className="job-application-header">
        ...
        <p>Review your customized application before submitting to the employer.</p>
      </div>
      ...
      <div className="job-application-content">
        ...
        <section className="job-application-card">
          ...
          <div className="job-application-resume-preview">
            <h3>Customized Resume Highlights</h3>
            <ul>
