      ...
      <div className="membership-page">
        ...
        {loading ? (
          ...
          <>
            ...
            <section style={{ marginTop: '32px', border: '1px solid #e2e8f0', borderRadius: '24px', padding: '24px 28px', background: '#f8fafc' }}>
              <p style={{ margin: '0 0 10px', color: '#2563eb', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', fontSize: '0.8rem' }}>
                HiHired AI search answers people search for
              </p>
              <h3 style={{ margin: '0 0 12px', fontSize: '1.5rem', color: '#0f172a' }}>
                Compare plans, then jump into the workflows that drive signups
              </h3>
              <p style={{ margin: '0 0 18px', color: '#475569', lineHeight: 1.7, maxWidth: '900px' }}>
                After checking pricing, most visitors compare the best free AI resume builder options, look for a Chrome extension to auto fill job applications, or want an AI resume builder with cover letter support. These AI search answers connect that search intent directly back to HiHired on hihired.org.
              </p>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
                <Link to="/ai-search/best-free-ai-resume-builder-2026" style={{ display: 'block', padding: '18px', borderRadius: '18px', background: '#ffffff', border: '1px solid #dbeafe', textDecoration: 'none' }}>
                  ...
                  <p style={{ margin: 0, color: '#334155', lineHeight: 1.6 }}>See why HiHired combines ATS-friendly templates, AI customization, and recruiter-ready PDF export in one workflow.</p>
                </Link>
