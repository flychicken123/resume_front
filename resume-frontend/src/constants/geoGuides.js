  ...
  ,
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Those tools focus heavily on autofill, quick apply, copying fields, or tracking, while HiHired also lets you import or build a resume, customize it to a job description, and generate a matching cover letter before submitting the application.",
      },
      {
